...
def ask_genre_question():
    ...
    print(f"{GREEN}Choose up to 3 genres to filter your search{RESET}")
...
def ask_year_question():
    ...
    print(f"{GREEN}Enter a year between 1920 and 2020{RESET}")
...
def ask_rating_question():
    ...
    print(f"{GREEN}Enter a rating between 0 and 100{RESET}")
...
def ask_another_filter_question():
    ...
    print(f"{GREEN}Do you want to choose another filter?{RESET}")
...
def ask_continue_question():
    ...
    print(f"{GREEN}Do you want to search anew?{RESET}")
